...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent: QWidget, client: Client):
        ...
        self.current_room_mute_unmute_button = QPushButton("Mute mic")
    ...
    def mute_unmute(self, event):
        if self.current_room_mute_unmute_button.text() == "Mute mic":
            self.client.mute()
            self.current_room_mute_unmute_button.setText("Unmute mic")
        else:
            self.client.unmute()
            self.current_room_mute_unmute_button.setText("Mute mic")
